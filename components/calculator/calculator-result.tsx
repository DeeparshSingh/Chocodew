...
export function CalculatorResult({ 
  ...
  const roundedBags = Math.ceil(bagsPerMonth * 10) / 10; // Round to 1 decimal place
  ...
  return (
    ...
    >
      <Card className="border-accent/30 bg-gradient-to-br from-secondary/20 to-background">
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-4 rounded-lg bg-background shadow-sm">
              <h4 className="text-sm font-medium text-muted-foreground mb-1">Monthly Consumption</h4>
              <p className="text-3xl font-bold">{cupsPerMonth}</p>
              <p className="text-sm">cups</p>
            </div>
            <div className="p-4 rounded-lg bg-background shadow-sm">
              <h4 className="text-sm font-medium text-muted-foreground mb-1">Premix Required</h4>
              <p className="text-3xl font-bold">{roundedBags}</p>
              <p className="text-sm">kg per month</p>
            </div>
            <div className="p-4 rounded-lg bg-background shadow-sm">
              <h4 className="text-sm font-medium text-muted-foreground mb-1">Recommended Order</h4>
              <p className="text-3xl font-bold text-primary">{recommendedBags}</p>
          ...
          <div className="bg-primary/5 p-4 rounded-lg">
            ...
            <ul className="space-y-1">
              ...
              <li>Total monthly usage: {(cupsPerMonth * gramsPerCup).toLocaleString()}g ({roundedBags}kg)</li>
